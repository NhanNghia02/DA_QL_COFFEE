    ...
    return (
        <div className="container">
            ...
            <div className="mb-4">
                ...
                />
                <button className="btn btn-primary mt-3" onClick={editCategory ? handleSave : handleAddCategory}>
                    {editCategory ? "Lưu Danh Mục" : "Thêm Danh Mục"}
                </button>
            </div>
                ...
                {categories.map((category) => (
                    <li key={category.id} className="list-group-item d-flex justify-content-between align-items-center">
                        <div className="d-flex align-items-center">
                            <div className="d-flex flex-column text-left"><strong>Tên: {category.name}</strong></div>
                        </div>
                        <div className="d-flex align-items-center">
                            <div>{category.image && <img src={category.image} alt={category.name} style={{ width: "50px" }} />}</div>
                        </div>
                        <div>
